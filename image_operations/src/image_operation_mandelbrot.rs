...
pub struct ImageOperationMandelbrot {
    pub val: i32,
    pub bitmapdata: Rc<PixelImageSimple>,
    pub palette: PaletteRainbowColorsRGBA8
}

impl ImageOperation for ImageOperationMandelbrot {
    fn execute_op(&self) {
        println!("ImageOperationMandelbrot - val = {}, width = {}, height = {}",
